          ...
          <div className="col-lg-7">
            <div className="score-right-content">
              <div className="recommendation-item">
                ...
                <p>
                  Based on your score, our ergonomics expert has provided a few
                  recommendations.
                </p>
              </div>
              <div className="score-list-items">
                ...
                <div className="score-list-item">
                  ...
                  <div className="score-item-content">
                    ...
                    <p>
                      ...
                      continued effectiveness and early detection of emerging
                      issues.
                    </p>
                  </div>
                </div>
                <div className="score-list-item">
                  ...
                  <div className="score-item-content">
                    ...
                    <p>
                      Stay updated on ergonomics trends and innovations to keep
