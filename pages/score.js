                  ...
                  <div className="score-list-items">
                    <div className="score-list-item">
                      <div className="score-item-icon score-item-icon-1">
                        <img src="/img/icon/score-1.svg" alt="" />
                      </div>
                    ...
                    <div className="score-list-item">
                      <div className="score-item-icon score-item-icon-2">
                        <img src="/img/icon/score-2.svg" alt="" />
                      </div>
                      <div className="score-item-content">
                    ...
                    <div className="score-list-item">
                      <div className="score-item-icon score-item-icon-3">
                        <img src="/img/icon/score-3.svg" alt="" />
                      </div>
                      <div className="score-item-content">
                    ...
                    <div className="score-list-item">
                      <div className="score-item-icon score-item-icon-4">
                        <img src="/img/icon/score-4.svg" alt="" />
                      </div>
                      <div className="score-item-content">
                  ...
                  <div className="score-list-items">
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        <h4>Spot the Gaps:</h4>
                        <p>
                          Identify specific areas of inconsistency by reviewing
                          survey responses or conducting frequent assessments.
                        </p>
                      </div>
                    </div>
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        <h4>Strengthen the Foundation:</h4>
                        <p>
                          Develop or update ergonomics policies to close
                          existing gaps and ensure consistent implementation.
                        </p>
                      </div>
                    </div>
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        <h4>Examine and Elevate:</h4>
                        <p>
                          Invest in training for managers and employees to
                          improve awareness and adoption of ergonomics best
                          practices.
                        </p>
                      </div>
                    </div>
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        <h4>Spark Sustainable Change:</h4>
                        <p>
                          Introduce ergonomic equipment or adjustments on a
                          case-by-case basis, and monitor progress through
                          follow-up assessments to track improvements over time.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="score-list-items">
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        ...
                        <p>
                          Conduct a comprehensive ergonomics audit across all
                          departments to identify the root causes of risks.
                        </p>
                      </div>
                    </div>
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        ...
                        <p>
                          Focus on high-risk areas for immediate intervention to
                          prevent injuries and enhance well-being.
                        </p>
                      </div>
                    </div>
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        ...
                        <p>
                          Allocate resources for ergonomic upgrades—equipment,
                          furniture, training, and assessments—based on
                          identified needs.
                        </p>
                      </div>
                    </div>
                    <div className="score-list-item">
                      ...
                      <div className="score-item-content">
                        ...
                        <p>
                          Establish a dedicated ergonomics team or champion and
                          implement a structured program with education,
                          equipment management, and continuous monitoring.
                        </p>
                      </div>
                    </div>
                  </div>
